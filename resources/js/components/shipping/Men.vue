                            ...
                            <div class="row">
                                <div class="col text-left">
                                    <small
                                        ...
                                        >showing {{ this.shippings.from }}-{{
                                            this.shippings.to
                                        }}
                                        of
                                        {{ this.shippings.total }} items</small
                                    >
                                </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    class="form-control"
                                    :class="{
                                        'is-invalid': form.errors.has('dure')
                                    }"
                                />
                                <has-error
                                    :form="form"
...
export default {
    ...
    data() {
        return {
            editmode: false,
            type: "company",
            url: this.$app_url + "/api/shipping?type=men",
            search_term: "",
            shippings: {},
    ...
    methods: {
        ...
        getResults(page = 1) {
            ...
            axios
                .get("api/shipping?page=" + page)
                .then(({ data }) => (this.shippings = data.data));

            this.$Progress.finish();
        },
        loadshippings(url= this.url) {
        ...
        createshipping() {
            ...
            this.form.type = "men";
            this.form
                .post(this.$app_url + "/api/shipping")
                .then(data => {
        ...
        updateshipping() {
            this.$Progress.start();
            this.form
                .put(this.$app_url + "/api/shipping/" + this.form.id)
                .then(response => {
                    // success
                    $("#addNew").modal("hide");
                    Toast.fire({
        ...
        showDeliveryMen(shipping) {
            this.$router.push({ path: `/shipping/delivery/${shipping.id}` });
        }
    },
    created() {
        this.$Progress.start();
